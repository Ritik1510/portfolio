...
const AboutCardContent = ({ content }) => {
  ...
  return (
    <div className="about-info-group p-2 border-[0.2367px] flex items-start lg:p-4 rounded-lg transition-all ease-out text-zinc-200 text-base sm:p-2 group">
      ...
      <div className="flex flex-col pl-3 gap-1">
        ...
        <div className="flex items-center">
          <span className="font-bold tracking-wide md:text-md lg:text-xl pr-3 text-white group-hover:text-primary-dark">
            {content.title}
          </span>
          {content.link && (
